...
export default function PopupManagerPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            toast.success("บันทึกการตั้งค่าป๊อปอัพสำเร็จ!");
        } catch (error) {
                ...
                <CardBody className="p-4 sm:p-6 pt-0 space-y-6">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-400">รูปภาพป๊อปอัพ</label>
