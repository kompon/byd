...
export default function SettingsPage() {
    ...
    if (loading) return <div className="p-8 text-slate-900 dark:text-white">กำลังโหลด...</div>;
    ...
    return (
        <div className="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6 mb-6">
            ...
            <div className="space-y-6">
                <Card>
                    <CardHeader>
                        <h4 className="text-lg font-semibold text-gray-800 dark:text-white/90">ตั้งค่าทั่วไป</h4>
                    </CardHeader>
                    <CardBody className="p-4 sm:p-6 pt-0">
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-400">โลโก้เว็บไซต์</label>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex gap-2">
                                            ...
                                            <label className="flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors">
                                                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">อัพโหลด</span>
                                                <input
                                                    type="file"
                                                    className="hidden"
                                                    accept="image/*"
                ...
                <Card>
                    <CardHeader>
                        <h4 className="text-lg font-semibold text-gray-800 dark:text-white/90">ส่วน Hero</h4>
                    </CardHeader>
                    <CardBody className="p-4 sm:p-6 pt-0">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">โลโก้ Headline</label>
                                <div className="flex gap-4 items-start">
                                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-700 dark:border-gray-600 transition-colors">
                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">คลิกเพื่ออัพโหลดโลโก้</span></p>
