...
export default function AdminDashboard() {
    ...
    if (stats.loading) {
        return <div className="p-8 flex justify-center text-gray-500 dark:text-gray-400">กำลังโหลด...</div>;
    }

    return (
        <div className="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6 mb-6">
            <div className="mb-8">
                <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent mb-2">แดชบอร์ด</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400">ภาพรวมการดำเนินงานของโชว์รูม</p>
            </div>
                ...
                <Card className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden relative">
                    ...
                    <CardBody className="p-6 relative">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <span className="px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-emerald-50 to-green-50 text-emerald-700 border border-emerald-200 dark:from-emerald-500/10 dark:to-green-500/10 dark:text-emerald-400 dark:border-emerald-500/20">+2 ใหม่</span>
                        </div>
                        <div>
                            <p className="text-gray-600 text-sm font-semibold mb-2 dark:text-gray-400 uppercase tracking-wider">จำนวนรุ่นรถทั้งหมด</p>
                ...
                <Card className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden relative">
                    ...
                    <CardBody className="p-6 relative">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <span className="px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-emerald-50 to-green-50 text-emerald-700 border border-emerald-200 dark:from-emerald-500/10 dark:to-green-500/10 dark:text-emerald-400 dark:border-emerald-500/20">ใช้งานอยู่</span>
                        </div>
                        <div>
                            <p className="text-gray-600 text-sm font-semibold mb-2 dark:text-gray-400 uppercase tracking-wider">โปรโมชั่นที่ใช้งานอยู่</p>
                    ...
                    <CardBody className="p-6 relative">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 dark:from-emerald-500/10 dark:to-green-500/10 dark:border-emerald-500/20">
                                ...
                                <span className="text-xs font-bold text-emerald-700 dark:text-emerald-400 uppercase">ออนไลน์</span>
                            </div>
                        </div>
                        <div>
                            <p className="text-gray-600 text-sm font-semibold mb-2 dark:text-gray-400 uppercase tracking-wider">สถานะระบบ</p>
                            <h3 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">พร้อมใช้งาน</h3>
                        </div>
                    </CardBody>
                </Card>
            </div>
