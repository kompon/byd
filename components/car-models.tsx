...
const CarCard = ({ car, t }: { car: any, t: any }) => (
    <Card
        className="relative border-0 transition-all duration-500 group h-full rounded-[2rem] overflow-hidden mb-4 bg-gradient-to-br from-blue-50/80 via-white/60 to-indigo-50/80 backdrop-blur-xl hover:from-blue-100/90 hover:via-white/70 hover:to-indigo-100/90"
    >
        {/* Glow Effect */}
        ...
        <CardBody className="overflow-hidden p-0 relative h-52 w-full flex items-center justify-center z-10">
            <div className="absolute inset-0 flex items-center justify-center p-4 transition-transform duration-500 group-hover:-translate-y-2 group-hover:scale-105">
                <Image
                    radius="none"
                    width="100%"
                    alt={car.name}
                    className="w-full h-full object-contain max-h-44 drop-shadow-xl group-hover:drop-shadow-2xl"
